...
static void gui_draw_eyefi(int arg);
...
extern CMenu* eyefi_scan_enter_submenu(int arg);
...
CMenu games_submenu = {0x38,LANG_MENU_GAMES_TITLE, NULL, games_submenu_items };
void blank_menu()
{};

CMenuItem eyefi_scan_submenu_items[] = {
	MENU_ITEM(0x35,LANG_MENU_EYEFI_SCAN,      MENUITEM_PROC,  eyefi_scan_enter_submenu,0),
	MENU_ITEM(0x35,LANG_MENU_ITEM_BLANK,      MENUITEM_PROC,  blank_menu,0),
	MENU_ITEM(0x35,LANG_MENU_ITEM_BLANK,      MENUITEM_PROC,  blank_menu,0),
	MENU_ITEM(0x35, LANG_MENU_ITEM_BLANK,      MENUITEM_PROC,  blank_menu,0),
	MENU_ITEM(0x35, LANG_MENU_ITEM_BLANK,      MENUITEM_PROC,  blank_menu,0),
	MENU_ITEM(0x35, LANG_MENU_ITEM_BLANK,      MENUITEM_PROC,  blank_menu,0),
...
CMenu eyefi_scan_submenu = {0x35, LANG_MENU_EYEFI_SCAN, NULL, eyefi_scan_submenu_items };

static CMenuItem eyefi_submenu_items[] = {
    MENU_ITEM(0x35,LANG_MENU_EYEFI_SCAN,		MENUITEM_PROC, eyefi_scan_enter_submenu ,0),
    MENU_ITEM(0x35,LANG_MENU_EYEFI_LIST_CONF_NETS,	MENUITEM_SUBMENU, &eyefi_scan_submenu,0),
    MENU_ITEM(0x51,LANG_MENU_EYEFI_REBOOT,           	MENUITEM_UP ,0,0),
    MENU_ITEM(0x51,LANG_MENU_EYEFI_CARD_INFO,         MENUITEM_UP ,0,0),
    MENU_ITEM(0x51,LANG_MENU_BACK,                    MENUITEM_UP, 0, 0 ),
    {0}
};
static CMenu eyefi_submenu = {0x35, LANG_MENU_EYEFI_TITLE, NULL, eyefi_submenu_items };
...
static CMenuItem misc_submenu_items[] = {
    MENU_ITEM(0x35,LANG_MENU_EYEFI_TITLE,       	MENUITEM_SUBMENU, &eyefi_submenu, 0 ),
...
static CMenuItem operation_submenu_items[] = {
      MENU_ITEM(0x5e,LANG_MENU_EYEFI_TITLE,               MENUITEM_PROC,    gui_draw_eyefi,0 ),
...
static CMenuItem root_menu_items[] = {
	// FIXME take this out later shortcut for now
    MENU_ITEM(0x21,LANG_MENU_EYEFI_TITLE,       	MENUITEM_SUBMENU,   &eyefi_submenu ,0),
...
//-------------------------------------------------------------------
void gui_draw_eyefi(int arg) {
    gui_eyefi_init(LANG_MENU_EYEFI_TITLE, "A", NULL);
}
